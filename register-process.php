<?php
    ...
    if(isset($_POST['submitRegister'])){
        ...
        if(!$errorbool){
            ...
            // prepare and bind
            $stmt = $connection->prepare("SELECT COUNT(*) AS rownumber FROM users WHERE username = ?;");
            ...
            if($data['rownumber'] == 0){
                ...
                echo "<script>";
                    echo "alert('Username tidak tersedia. Harap mengganti username dengan yang lain !')";
                echo "</script>";
